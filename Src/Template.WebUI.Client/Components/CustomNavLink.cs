...
namespace Microsoft.AspNetCore.Components.Routing
{
    ...
    public class CustomNavLink : ComponentBase, IDisposable
    {
        ...
        [Parameter]
        public string? URLPartToBeActive { get; set; }
        ...
        protected override void OnParametersSet()
        {
            ...
            if (URLPartToBeActive.IsNotNullOrEmpty())
                href = URLPartToBeActive;
            else
            {
            ...
            _class = (string?)null;
            if (AdditionalAttributes != null && AdditionalAttributes.TryGetValue("class", out var obj2))
            {
                _class = Convert.ToString(obj2, CultureInfo.InvariantCulture);
            }
